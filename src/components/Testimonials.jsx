...
export default function Testimonials() {
  ...
  return (
    <section id="faq" className="scroll-mt-[--header-h] border-t border-theme-fg/15">
      <div className="grid grid-cols-1 lg:min-h-[calc(100svh-var(--header-h))] lg:grid-cols-[1fr_2fr_1fr] lg:divide-x lg:divide-theme-fg/15">
        ...
        <div className="flex flex-col justify-between gap-24 border-t border-theme-fg/15 p-20 lg:border-t-0">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              {/* Headshot placeholder — CMS asset drops in here */}
              <div className="flex aspect-square w-100 items-center justify-center bg-mint font-mono text-caption-20 uppercase text-black/70">
                {current.name
                  .split(' ')
                  .map((n) => n[0])
                  .join('')}
              ...
              <dl className="mt-auto flex flex-col gap-12 border-t border-theme-fg/15 pt-16">
                <div className="flex flex-col gap-4">
                  <dt className="font-mono text-caption-10 uppercase opacity-50">Position</dt>
                  <dd className="text-body-10">{current.position}</dd>
                </div>
                <div className="flex flex-col gap-4">
                  <dt className="font-mono text-caption-10 uppercase opacity-50">Company</dt>
